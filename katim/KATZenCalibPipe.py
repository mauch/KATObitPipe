...
def MKContPipeline(files, outputdir, **kwargs):
    ...
    fluxcals = katpoint.Catalogue(open(FITSDir.FITSdisks[0]+"/"+parms["fluxModel"]))
    ...
    if kwargs.get('reuse'):
        ...
        obsdata = KATH5toAIPS.KAT2AIPS(katdata, uv, disk, fitsdisk, err, calInt=katdata.dump_period, **kwargs)
